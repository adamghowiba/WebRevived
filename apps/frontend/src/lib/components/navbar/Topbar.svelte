...
<header class="topbar">
	<svg class="topbar__logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 232 68">
		<path
	...
	<div class="menu">
		<Button
			...
			borderColor="gray"
			style="outline"
			icon={{ icon: 'iconoir:github', color: 'var(--color-gray-700)' }}>Source code</Button
		>
		<Button
			size="small"
			borderColor="gray"
			style="outline"
			icon={{ icon: 'ant-design:heart-outlined', color: 'var(--color-error)' }}>Sponser</Button
		>
		<Action on:click={changeTheme} icon="carbon:moon" />
	</div>
</header>
